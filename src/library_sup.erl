...
%         permanent, 2000, worker, [client]},
Client1 = {client1, {client_simulator, start, [client1]},
        permanent, 2000, worker, [client_simulator]},
  Client2 = {client2, {client_simulator, start, [client2]},
        permanent, 2000, worker, [client_simulator]},
  Client3 = {client3, {client_simulator, start, [client3]},
        permanent, 2000, worker, [client_simulator]},
  Client4 = {client4, {client_simulator, start, [client4]},
        permanent, 2000, worker, [client_simulator]},
  Children = [Server, Initializator, Client1, Client2, Client3, Client4],
